...
export default function WeatherImpact({ summary, customerId }: WeatherImpactProps) {
    ...
    return (
        <div className="space-y-6">
            <div>
                <h1 className="text-2xl font-bold text-slate-900 mb-2">Weather Impact Analysis</h1>
                <p className="text-slate-500">Understand how weather patterns affect your energy consumption.</p>
            </div>
